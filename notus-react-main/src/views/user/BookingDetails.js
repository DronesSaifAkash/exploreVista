    ...
    useEffect(() => {
        const fetchBooking = async () => {
            ...
            try {
                ...
                const response = await axios.get(`/api/users/bookings/${id}`, {
                    headers: {
                ...
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-lightBlue-200 border-0">
                    <div className="rounded-t bg-white mb-0 px-6 py-6">
                        <div className="container mx-auto p-4">
                            ...
                            {booking && (
                                <div className=" p-4  rounded-lg">
                                    ...
                                    <p><strong>Package Name:</strong> {booking.tourPackageId?.name || 'Loading...'}</p> {/* Adjust according to your tour package field */}
                        ...
                        <div className="p-4 text-right text-xl hover:opacity-85 ">
                            <Link to="/user/booking-packages" title="Click to Back">
